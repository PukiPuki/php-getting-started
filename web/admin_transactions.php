...
if (isset($_POST['add_transaction'])) {
    $query = "SELECT * FROM admin_add_transactions('$_POST[location]', '$_POST[pickupdate]', '$_POST[returndate]', '$_POST[itemid]')";
    ...
    if ($result) {
        ...
        if (isset($_POST['delete_transaction'])) {
            $query = "SELECT * FROM admin_remove_transaction('$_POST[location]','$_POST[pickupdate]','$_POST[returndate]','$_POST[itemid]')";
            $result = pg_query($pg_conn, $query) or die('Query failed: ' . pg_last_error());
                    if (!$result) {
            echo "<script type='text/javascript'>
